...
var Module = typeof createWasmThreadsModule !== "undefined" ? createWasmThreadsModule : {};
...
wasmBinaryFile = "wasm_threads.wasm";
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var pthreadMainJs = locateFile("wasm_threads.worker.js");
...
run();
  ...
  return createWasmThreadsModule.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = createWasmThreadsModule;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return createWasmThreadsModule; });
else if (typeof exports === 'object')
  exports["createWasmThreadsModule"] = createWasmThreadsModule;
